...
\draw   (190.14,51.86) .. controls (190.14,47.44) and (193.72,43.86) .. (198.14,43.86) -- (263.14,43.86) .. controls (267.56,43.86) and (271.14,47.44) .. (271.14,51.86) -- (271.14,75.86) .. controls (271.14,80.28) and (267.56,83.86) .. (263.14,83.86) -- (198.14,83.86) .. controls (193.72,83.86) and (190.14,80.28) .. (190.14,75.86) -- cycle ;
...
\draw [color={rgb, 255:red, 0; green, 0; blue, 0}  ,draw opacity=1 ][fill={rgb, 255:red, 0; green, 0; blue, 0}  ,fill opacity=1 ]   (289.75,159.38) -- (290.2,178.63) ;
\draw [shift={(290.25,180.63)}, rotate = 268.65] [color={rgb, 255:red, 0; green, 0; blue, 0}  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da47708478900224005] 
\draw [color={rgb, 255:red, 0; green, 0; blue, 0}  ,draw opacity=1 ][fill={rgb, 255:red, 0; green, 0; blue, 0}  ,fill opacity=1 ]   (160.25,141.88) -- (160.75,159.88) ;
%Straight Lines [id:da21636913810049396] 
\draw [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ][fill={rgb, 255:red, 255; green, 73; blue, 92 }  ,fill opacity=1 ]   (160.75,159.88) -- (289.75,159.38) ;
...
% Text Node
\draw (177.52,10.84) node [anchor=north west][inner sep=0.75pt]   [align=left] {A};
% Text Node
\draw (293.75,10.84) node [anchor=north west][inner sep=0.75pt]   [align=left] {B};
% Text Node
\draw (225.41,12.62) node [anchor=north west][inner sep=0.75pt]   [align=left] {uu};
% Text Node
\draw (158.47,120.86) node [anchor=north west][inner sep=0.75pt]   [align=left] {A};
% Text Node
\draw (314.92,120.86) node [anchor=north west][inner sep=0.75pt]   [align=left] {B};
% Text Node
\draw (225.92,123.08) node [anchor=north west][inner sep=0.75pt]   [align=left] {uu};
% Text Node
\draw (221.12,256.62) node [anchor=north west][inner sep=0.75pt]   [align=left] {B};
% Text Node
\draw (152.56,258.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {uu};
% Text Node
\draw (305.23,256.29) node [anchor=north west][inner sep=0.75pt]   [align=left] {A};
% Text Node
\draw (194.14,54.86) node [anchor=north west][inner sep=0.75pt]   [align=left] {\treapSplit(uu)};
% Text Node
\draw (191.29,191.89) node [anchor=north west][inner sep=0.75pt]   [align=left] {\treapJoin(uu, B, A)};
