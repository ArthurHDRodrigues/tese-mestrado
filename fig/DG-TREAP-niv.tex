...
\draw (18.25,3.3) node[anchor=center] {8};
...
\draw [line width=1pt,color=ccqqqq] (22.75,2) circle (0.5cm);
\draw (22.75,2) node[anchor=center] {$wu$};
\draw (22.75,1.3) node[anchor=center] {1};


\draw [line width=1pt] (15.25,3) circle (0.5cm);
\draw (15.25,3) node[anchor=center] {$yy$};
\draw (15.25,2.3) node[anchor=center] {4};
...
\draw (16.75,1.3) node[anchor=center] {2};
...
\draw (19.75,1.3) node[anchor=center] {1};
...
\draw [line width=1pt,color=ccqqqq] (17.7,1) circle (0.5cm);
\draw (17.7,1) node[anchor=center] {$zy$};
\draw (17.6,0.3) node[anchor=center] {1};

\draw [line width=1pt,color=ccqqqq] (15.8,1) circle (0.5cm);
\draw (15.8,0.3) node[anchor=center] {1};
