...
\draw [line width=2pt,color=red] (1,2.5) to[out=0,in=90,looseness=1] (2.5,1); % F0 -- F3
\draw [line width=.5pt] (1,2.5) to[out=0,in=90,looseness=1] (2.5,1); % F0 -- F3
...
\draw (3,1.7) node[anchor=south east,color=red] {$T^\star$};
