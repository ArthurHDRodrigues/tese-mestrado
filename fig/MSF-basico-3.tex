...
\draw [line width=2pt,color=cyan] (0,4) to  (2.3,2.85);   
\draw [line width=.5pt] (0,4) to  (2.3,2.85);   
...
\draw [line width=2pt,color=cyan] (4,2) to  (4.7,2.6);   
\draw [line width=.5pt] (4,2) to  (4.7,2.6);   
\draw [line width=2pt,color=cyan] (4,2) to[out=-45,in=0,looseness=4]  (5.2,2.8);   
\draw [line width=.5pt] (4,2) to[out=-45,in=0,looseness=4]  (5.2,2.8);   
\draw [fill=black] (4.9,2.75) circle (1.5pt);
\draw [fill=black] (4.7,2.6) circle (1.5pt);
\draw [fill=black] (5.2,2.8) circle (1.5pt);

% Aresta d
\draw [line width=2pt,color=red] (2,2) to  (2.25,1.4);   
\draw [line width=.5pt] (2,2) to  (2.25,1.4);   
