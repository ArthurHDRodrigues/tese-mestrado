...
que \NEW{será elaborado na Seção~\ref{sec:lim-verificacao-Sk}}. Para transportar o limitante de um problema para o outro, reduziremos o problema VSP$S_k$ ao problema de conexidade em grafos dinâmicos.
