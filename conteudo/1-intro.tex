...
%\NEW{
%Logo, a solução de Thorup~\cite{Thorup2000} deixa de ser ótima somente por um fator de $\O{(\lg\lg n)^3}$.
%}
...
\NEW{
O consumo de tempo dessa heurística é linear em função do diâmtro do grafo, portanto as operações de atualização e de consulta possuem consumo de tempo assintótico de~$\O{n}$.
}
