...
\NEW{
Começaremos o Capítulo~\ref{sec:avaliacao-empirica} resumindo resultados de estudos experimentais envolvendo algoritmos que resolvem o problema de conexidade em grafos dinâmicos.
Em seguida, faremos um estudo próprio comparando o algoritmo explicado no Capítulo~\ref{sec:connDG} com seu principal concorrente na literatura.
}
