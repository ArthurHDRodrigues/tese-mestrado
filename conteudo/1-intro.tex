...
\NEW{
Nos problemas que estudaremos nesse texto, consideraremos que o grafo inicial~$G_0$ não possui arestas.
}
...
Nosso estudo experimental indica que o algoritmo de Holm et al.~\cite{poly_log} também supera o desempenho da heuristica de Chen et al. em grafos com diâmetro acima de $16$.\TODO{Atualizar isso após experimentos}
