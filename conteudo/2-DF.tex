...
Para manter os códigos mais legivéis, vamos abreviar chamadas repetidas de \treapJoin{}, isto é, ao invés de escrever~$\treapJoin(\treapJoin(\ldots(\treapJoin(T_1,T_2),T_3)\ldots),T_k)$ escreveremos simplesmente \treapJoin($T_1,\ldots, T_k$).
}
