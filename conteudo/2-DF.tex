...
Com a rotina \ETmovetofront{} implementada, podemos elaborar~\dymForestAddEdge{}, descrita no Algoritmo~\ref{Algo:dymForestAddEdge} \NEW{e diagramada na Figura~\ref{fig:algorit-add-sequencias}}.
