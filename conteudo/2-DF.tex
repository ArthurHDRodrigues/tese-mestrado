...
\NEW{
Essa rotina recebe uma floresta~$F$ e um vértice~$u$ e restrutura a ABB que contém $uu$ de forma que este se torne o primeiro elemento de sua sequências Euleriana e retorna a raiz da ABB resultante. 
}
...
\end{equation}
\NEW{
Por sua vez, para implementar~\ETmovetofront{}, precisaremos das seguintes rotinas da biblioteca de Euler tour trees. A implementação de \dymForestDelEdge{} também utilizará essas rotinas.
}
\begin{itemize}
