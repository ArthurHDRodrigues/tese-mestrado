...
Nessa ocasião, precisamos percorrer o caminho do nó que representa a aresta rebaixada até sua raiz decrementando~$cniv$, o que consome tempo esperado~$\O{\lg n}$. Como cada iteração desse laço já consome tempo esperado~$\O{\lg n}$, manter esse campo não prejudica o consumo de tempo da rotina.
