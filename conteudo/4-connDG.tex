...
Como $x$ e $y$ estão em componentes distintas quando removemos $uv$, temos que $uv$ é uma aresta de~$P$ e assim que $uv$ está em $F_{\leqslant j}$, o que é uma contradição com o fato de~$uv$ ser uma aresta de nível~$i$.
}
