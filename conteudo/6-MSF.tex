...
Por exemplo, para calcular o diagrama de Voronoi de um conjunto de pontos, Guibas e Stolfi~\cite{stolfi} mantêm, além do diagrama em si, a triangulação de Delaunay do mesmo conjunto de pontos, que é a estrutura dual associada ao diagrama de Voronoi.
