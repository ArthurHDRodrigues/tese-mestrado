...
A Figura~\TODO{bla} ilustra esse exemplo logo após a linha~\ref{Algo:MSFupdate:linhasplit} e antes da linha~\ref{Algo:MSFupdate:linhas:Merge} do Algoritmo~\ref{Algo:MSFupdate}.
Note que há duas árvores azuis e duas vermelhas.
A Figura~\TODO{ble} ilustra esse exemplo após a conclusão da chamada \MSFupdate($G$, $a$, $5$).
