...
\newcommand{\treapSplitRight}{\AlgoName{corta Direita}}
\newcommand{\treapGetSize}{\AlgoName{tamanho}}
\newcommand{\treapGetEdgesLevel}{\AlgoName{arestasDeNível}}

\newcommand{\treapFirst}{\AlgoName{first}}
\newcommand{\treapLast}{\AlgoName{last}}
...
\newcommand{\linkcutCreate}{\AlgoName{make node}}
...
\newcommand{\linkcutMax}{\AlgoName{\AlgoName{find max}}}    %(F, u, v)
\newcommand{\linkcutMin}{\AlgoName{\AlgoName{find min}}}    %(F, u, v)
\newcommand{\linkcutParent}{\AlgoName{\AlgoName{find parent}}}    %(F, u, v)
...
\newcommand{\LCOMakeNode}{\AlgoName{Make node}}
...
\newcommand{\LCOPredecessor}{\AlgoName{\AlgoName{Pred}}}    %(F, u, v)
\newcommand{\LCOConnected}{\AlgoName{\AlgoName{Connected}}}    %(F, u, v)
\newcommand{\LCOLeftFace}{\AlgoName{\AlgoName{LeftFace}}}
\newcommand{\LCONextRot}{\AlgoName{\AlgoName{NextRot}}}
\newcommand{\LCOFindNode}{\AlgoName{Find node}}
\newcommand{\LCOFindSubNode}{\AlgoName{Find subnode}}
...
\input{conteudo/6-MSF}
\input{conteudo/7-limitante}
\input{conteudo/8-conclusoes}
