...
%    \addplot[orange] table [x=ts, y=Dtree, col sep=comma] {#1};
%	    \label{pgfplots:Dtree:#3}
%    \addplot[brown] table [x=ts, y=nDtree, col sep=comma] {#1};
%	    \label{pgfplots:nDtree:#3}
    \addplot[black] table [x=ts, y=HK, col sep=comma] {#1};
	    \label{pgfplots:HK:#3}
    \addplot[blue] table [x=ts, y=HDT, col sep=comma] {#1};
