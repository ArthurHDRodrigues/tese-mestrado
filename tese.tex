...
\newcommand\fs@nobottomruled{\def\@fs@cfont{\bfseries}\let\@fs@capt\floatc@ruled
  ...
  \def\@fs@mid{\vspace{1mm}}%\kern2pt\hrule\kern2pt
...
\newcommand{\random}{\text{rand}} %(max_rand) escolhe um inteiro não negativo menor que max_rand
...
\newcommand{\graphAdd}{\text{addEdgeGLA}}
...
\newcommand{\treapSearch}{\text{search}}
\newcommand{\treapGetLast}{\text{getLast}}
\newcommand{\treapGetRoot}{\text{getRoot}}
\newcommand{\treapOrder}{\text{order}}
\newcommand{\treapJoin}{\text{join}}
\newcommand{\treapSplit}{\text{split}}
\newcommand{\treapGetSize}{\text{getSize}}
...
\newcommand{\dymForestQuery}{\text{connectedDF}}    %(F, u, v)
...
\newcommand{\dymGraphQuery}{\text{connected}} %(G, u, v)
\newcommand{\dymGraphReplace}{\text{replace}} %(G, u, v, i)
...
%\newcommand{\VPSPconvert}{\text{convert}}
%\newcommand{\VPSPupdate}{\text{update}}
%\newcommand{\VPSPverify}{\text{verify}}
