...
%     Métodos de C           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\malloc}{\text{alloc}}  %(int)
\newcommand{\free}{\text{delete}}    %(ptn)
\newcommand{\random}{\text{\AlgoName{S}{ORTEIE}}} %(max_rand) escolhe um inteiro não negativo menor que max_rand
\newcommand{\sizeof}{\text{sizeof}}  %(int)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Métodos de Grafos      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\graphCreate}{\text{newGLA}}
\newcommand{\graphAdd}{\text{\AlgoName{L}{IGUE\AlgoName{GLA}{}}}}
\newcommand{\graphDel}{\text{remEdgeGLA}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Métodos de Treap       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\treapCreate}{\text{newNode}}
\newcommand{\treapSearch}{\text{\AlgoName{B}{USCA}}}
\newcommand{\treapGetLast}{\text{getLast}}
\newcommand{\treapGetRoot}{\text{\AlgoName{R}{AIZ}}}
\newcommand{\treapOrder}{\text{\AlgoName{O}{RDEM}}}
\newcommand{\treapJoin}{\text{\AlgoName{J}{UNTA}}}
\newcommand{\treapSplit}{\text{\AlgoName{C}{ORTA}}}
\newcommand{\treapGetSize}{\text{\AlgoName{T}{AMANHO}}}
\newcommand{\treapGetEdgesLevel}{\text{getEdgesLevel}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Métodos de Euler Tour Tree %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\ETTCreate}{\text{newETTree}}     % (v)
\newcommand{\ETTAddEdge}{\text{addEdgeETT}} % ($F$, $uu$, $vv$)
\newcommand{\ETTDelEdge}{\text{remEdgeETT}} % ($F$, $uu$, $vv$)
\newcommand{\ETTQuery}{\text{connectedETT}} % ($F$, $uu$, $vv$)
\newcommand{\ETmovetofront}{\text{makeStart}} % ($F$, $uu$)
...
\newcommand{\nivel}{\text{NIVEL}} 
\newcommand{\hashCreate}{\text{{\AlgoName{C}{RIA}\AlgoName{D}{ICIO}}}}     
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\dymForestCreate}{\text{newDF}}  %(n)
\newcommand{\dymForestAddEdge}{\text{addEdgeDF}}    %(F, u, v)
\newcommand{\dymForestDelEdge}{\text{remEdgeDF}}    %(F, u, v)
\newcommand{\dymForestQuery}{\text{\AlgoName{C}{ONECTADO}\AlgoName{DF}{}}}    %(F, u, v)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Métodos de Grafos dinamicas %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\dymGraphCreate}{\text{newDG}}    %(n)
\newcommand{\dymGraphAddEdge}{\text{addEdge}} %(G, u, v)
\newcommand{\dymGraphDelEdge}{\text{remEdge}} %(G, u, v)
\newcommand{\dymGraphQuery}{\text{\AlgoName{C}{ONECTADO}}} %(G, u, v)
\newcommand{\dymGraphReplace}{\text{\AlgoName{R}{EPONHA}}} %(G, u, v, i)
...
%     Métodos de MSF         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\MSFCreate}{\text{newWDG}} %(n)
\newcommand{\MSFaddEdge}{\text{addWEdge}}    %(G, u, v, w)
\newcommand{\MSFdelEdge}{\text{delWEdge}}    %(G, u, v)
\newcommand{\MSFweight}{\text{MSFWeight}}    %(G)

\newcommand{\dymGraphReplaceMSF}{\text{\AlgoName{R}{EPONHA}}} %(G, u, v, i)
\newcommand{\treapGetEdgeMinWeight}{\text{getEdgeMinWeight}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Métodos de VPSP
% Verify partial sum of permutations%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\AlgoName}[2]{\text{#1{\footnotesize #2}}}
\newcommand{\VPSPconvert}{\AlgoName{C}{ONVERTA}}
\newcommand{\VPSPupdate}{\AlgoName{S}{UBSTITUA}}
\newcommand{\VPSPverify}{\AlgoName{V}{ERIFIQUE}}
...
\input{conteudo/2-DF}
\input{conteudo/3-treaps}
\input{conteudo/4-connDG}
\input{conteudo/experimentos}
\input{conteudo/limitante}
\input{conteudo/decremental}
\input{conteudo/MSF}
